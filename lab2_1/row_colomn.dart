    ...
    return Scaffold(
      ...
      body:Container(//контейнер принимает только один виджет поетому у него параметр child в котором мы и работаем
        ...
        child: Row(
            ...
            crossAxisAlignment: CrossAxisAlignment.center,//crossAxisAlignment выравнивание по поперечной оси, имеет 6 значений
            children: <Widget>[
              ColorBox(),
              BiggerColorBox(),
              ColorBox(),
...
class BiggerColorBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      height: 100,
      decoration: BoxDecoration(
        color: Colors.redAccent[800], // 400 обозначает фон цвета
        border: Border.all(),
      ),
    );
  }
